...
class ExamTestMain : Spek({
    group("Pengujian otomatis latihan") {
        describe("Pengecekkan Latihan 1") {
            it("Latihan 1") {
                isEvenNumber(
                    ...
                    errMessage = "Jika argumennya adalah 2, fungsi isEvenNumber() seharusnya mengembalikan nilai true"
                )
            }
            ...
            it("Latihan 1") {
                isEvenNumber(
                    ...
                    errMessage = "Jika argumennya adalah 6, fungsi isEvenNumber() seharusnya mengembalikan nilai true"
                )
            }
            ...
            it("Latihan 1") {
                isEvenNumber(
                    ...
                    errMessage = "Jika argumennya adalah 7, fungsi isEvenNumber() seharusnya mengembalikan nilai false"
                )
            }
            ...
            it("Latihan 1") {
                isEvenNumber(
                    ...
                    errMessage = "Jika argumennya adalah 1, fungsi isEvenNumber() seharusnya mengembalikan nilai false"
                )
            }
            ...
            for (number in 1..99 step 2) {
                it("Latihan 1") {
                    isEvenNumber(
                        ...
                        errMessage = "Jika argumennya adalah $number, fungsi isEvenNumber() seharusnya mengembalikan nilai false"
                    )
                }
            }
            ...
            for (number in 0..100 step 2) {
                it("Latihan 1") {
                    isEvenNumber(
                        ...
                        errMessage = "Jika argumennya adalah $number, fungsi isEvenNumber() seharusnya mengembalikan nilai true"
                    )
                }
            }
            ...
            it("Latihan 1") {
                moreThanFive(
                    ...
                    errMessage = "Jika argumennya adalah 1, fungsi moreThanFive() seharusnya mengembalikan nilai false"
                )
            }
            ...
            it("Latihan 1") {
                moreThanFive(
                    ...
                    errMessage = "Jika argumennya adalah 3, fungsi moreThanFive() seharusnya mengembalikan nilai false"
                )
            }
            ...
            it("Latihan 1") {
                moreThanFive(
                    ...
                    errMessage = "Jika argumennya adalah 5, fungsi moreThanFive() seharusnya mengembalikan nilai false"
                )
            }
            ...
            it("Latihan 1") {
                moreThanFive(
                    ...
                    errMessage = "Jika argumennya adalah 10, fungsi moreThanFive() seharusnya mengembalikan nilai true"
                )
            }
            ...
            it("Latihan 1") {
                moreThanFive(
                    ...
                    errMessage = "Jika argumennya adalah 30, fungsi moreThanFive() seharusnya mengembalikan nilai true"
                )
            }
        ...
        describe("Pengecekkan latihan 3") {
            it("Latihan 3") {
                val vehicle = vehicle()
                (vehicle is Map<*, *>).returnTrue(
                    "Fungsi vehicle() seharusnya mengembalikan nilai dengan tipe data Map<>"
                )
            }

            it("Latihan 3") {
                val vehicle: Map<String, String> = vehicle() as Map<String, String>
                (vehicle["type"] != null && vehicle["type"] == "motorcycle").returnTrue(
                    "Nilai kembalian vehicle() seharusnya terdapat key `type` dengan nilai `motorcycle`"
                )
            }

            it("Latihan 3") {
                val vehicle: Map<String, String> = vehicle() as Map<String, String>
                (vehicle["maxSpeed"] != null && vehicle["maxSpeed"] == "230Km/s").returnTrue(
                    "Nilai kembalian vehicle() seharusnya terdapat key `maxSpeed` dengan nilai `230Km/s`"
                )
            }

            it("Latihan 3") {
                val vehicle: Map<String, String> = vehicle() as Map<String, String>
                (vehicle["maxTank"] != null && vehicle["maxTank"] == "100Ltr").returnTrue(
                    "Nilai kembalian vehicle() seharusnya terdapat key `maxTank` dengan nilai `100Ltr`"
                )
            }
        }
        ...
        describe("Pengecekkan latihan 5") {
            it("Latihan 5") {
                runBlocking {
                    ...
                    (executionTime in 3001..3499).returnTrue(
                        "Pemanggilan fungsi sum() seharusnya terdapat jeda waktu minimal 3 detik"
                    )
                }
            }
            ...
            it("Latihan 5") {
                runBlocking {
                    ...
                    (result.await() == 10).returnTrue(
                        "Jika argumen untuk parameter a adalah 5 dan b adalah 5, fungsi sum() seharusnya mengembalikan nilai 10"
                    )
                }
            }
            ...
            it("Latihan 5") {
                runBlocking {
                    ...
                    (result.await() == 107).returnTrue(
                        "Jika argumen untuk parameter a adalah 100 dan b adalah 7, fungsi sum() seharusnya mengembalikan nilai 107"
                    )
                }
            }
            ...
            it("Latihan 5") {
                runBlocking {
                    ...
                    (executionTime in 2001..2499).returnTrue(
                        "Pemanggilan fungsi multiple() seharusnya terdapat jeda waktu minimal 2 detik"
                    )
                }
            }
            ...
            it("Latihan 5") {
                runBlocking {
                    ...
                    (result.await() == 36).returnTrue(
                        "Jika argumen untuk parameter a adalah 6 dan b adalah 6, fungsi multiple() seharusnya mengembalikan nilai 36"
                    )
                }
            }
            ...
            it("Latihan 5") {
                runBlocking {
                    ...
                    (result.await() == 25).returnTrue(
                        "Jika argumen untuk parameter a adalah 5 dan b adalah 5, fungsi multiple() seharusnya mengembalikan nilai 25"
                    )
                }
            }
        }
